        ...
        <>
            <div className = "container about-page"> 
                <div className = "text-zone"> 
                    ...
                    <p>
                    I’m a driven full-stack developer with a diverse background, equipped to collaborate well in teams, approach problems analytically, and apply technical skills to overcome challenges.
                    <br/>
                    <TechList />
